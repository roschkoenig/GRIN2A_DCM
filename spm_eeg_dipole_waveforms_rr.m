...
% dipoles = ft_transform_geometry(inv(data.transforms.toMNI), dipoles);pnt = dipoles.pos;
...
Gxyz = ft_compute_leadfield(dipoles.pos, sens, vol, 'reducerank', reducerank, 'dipoleunit', 'nA*m', 'chanunit', D.units(chanind));
